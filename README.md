# tax-doc-sdk-tax5498qa

Software development kit to generate IRS Form 5498-QA as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax5498Qa.sample.png" width="850"/>
