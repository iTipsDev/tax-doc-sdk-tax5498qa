...
import irs.fdxtax641.jsonserializers.Tax5498QaSerializer;
import irs.fdxtax641.map2objects.Map2Tax5498Qa;
import org.taxdataexchange.core.pdfbuilders.Tax5498QaPdfBuilder;
...
public class Tax5498QaDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax5498Qa obj = Map2Tax5498Qa.generate( row );
        {
            String asJson = Tax5498QaSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax5498Qa.csv";
        ...
        String outputFileName = "Tax5498Qa.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax5498QaDocumentGenerator generator = new Tax5498QaDocumentGenerator( );
